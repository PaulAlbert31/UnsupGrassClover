...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, proj_size=128):
        ...
        #Non-linear
        self.linear = nn.Sequential(nn.Linear(512*block.expansion, 512*block.expansion*4, bias=False),
                                    nn.BatchNorm1d(int(512*block.expansion*4)),
                                    nn.ReLU(inplace=True),
                                    nn.Linear(int(512*block.expansion*4), int(512*block.expansion*4)),
                                    nn.BatchNorm1d(int(512*block.expansion*4)),
                                    nn.ReLU(inplace=True),
                                    nn.Linear(int(512*block.expansion*4), proj_size))
